      ...
      {lines.map((segments, lineIndex) => {
        ...
        return (
          <motion.h1
            ...
            className="text-[clamp(52px,13vw,56px)] sm:text-[52px] md:text-[56px] lg:text-[80px] xl:text-[88px] 2xl:text-[96px] font-normal leading-[1.05] md:leading-[1.0] tracking-[-0.02em]"
            style={{
              color: '#0F172A',
