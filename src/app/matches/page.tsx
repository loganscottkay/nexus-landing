    ...
    <GlassCard className="p-7 md:p-8">
      ...
      <div className="flex items-start gap-4 mb-5">
        ...
        <div className="flex-1 min-w-0">
          ...
          <p className="text-[15px] text-text-muted">{match.desc}</p>
        </div>
        ...
        <div className="rounded-2xl p-5 mb-5" style={{ background: "rgba(255,255,255,0.2)", border: "1px solid rgba(255,255,255,0.35)" }}>
          <div className="flex items-start justify-between mb-4">
            <div className="flex items-start gap-3">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="#4A6CF7" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round" className="shrink-0 mt-0.5">
            ...
            <button onClick={() => alert("Coming soon")} className="text-accent-blue text-[14px] flex items-center gap-1 hover:underline shrink-0">
      ...
      {/* Prep Section */}
      <button onClick={() => setPrepOpen(!prepOpen)} className="flex items-center gap-2 text-[15px] font-semibold text-text-primary hover:text-accent-blue transition-colors">
        Prep for this call
            ...
            <div className="pt-4 mt-4 space-y-4 rounded-2xl p-5" style={{ background: "rgba(255,255,255,0.15)", border: "1px solid rgba(255,255,255,0.25)" }}>
              ...
              <div>
                ...
                <div className="space-y-2">
                  {["What is your current burn rate and runway?", "How did you acquire your first 100 customers?", "What is your primary technical moat?"].map((q) => (
  ...
  return (
    <GlassCard className="p-7 md:p-8">
      ...
      {match.mutual && match.contactEmail && (
        <>
          <button onClick={() => setContactOpen(!contactOpen)} className="text-accent-blue text-[14px] hover:underline flex items-center gap-1.5 mb-2">
      ...
      <Link href="/startup/1" className="text-accent-blue text-[14px] hover:underline mt-3 inline-block">View Full Profile</Link>
    </GlassCard>
  );
}
...
export default function MatchesPage() {
  ...
  return (
    <div className="min-h-screen flex bg-base text-text-primary relative">
      ...
      <Sidebar role="investor" activeLabel="Matches" />
            ...
            >
              {(tab === "upcoming" || tab === "all") &&
                upcomingMatches.map((m, i) => (
                  ...
                  >
                    {tab === "all" && (
                      <span className="text-[11px] px-2.5 py-1 rounded-full bg-accent-blue/8 text-accent-blue font-medium mb-2 inline-block">Upcoming</span>
                    )}
