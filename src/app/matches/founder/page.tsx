...
const upcomingMatches = [
  {
    ...
    desc: "Confirmed call to discuss Series Seed",
    status: "Confirmed" as const,
    datetime: "Wednesday, March 12 at 2:00 PM EST",
    relative: "In 3 days",
    metrics: [
      { value: "$1M", label: "Check Size" },
      { value: "Seed", label: "Stage" },
      { value: "AI/SaaS", label: "Focus" },
      { value: "12", label: "Portfolio Cos" },
    ],
  },
  {
    id: 2,
    ...
    name: "David Kim",
    firm: "a16z",
    desc: "Deep dive on AI infrastructure thesis",
    status: "Confirmed" as const,
    datetime: "Friday, March 14 at 10:30 AM EST",
    relative: "In 5 days",
    metrics: [
      { value: "$500K-$2M", label: "Check Size" },
      { value: "Seed/A", label: "Stage" },
      { value: "AI/Infra", label: "Focus" },
      { value: "40+", label: "Portfolio Cos" },
    ],
  },
  {
    id: 3,
    ...
    desc: "Follow-up on initial interest",
    status: "Scheduling..." as const,
    datetime: undefined,
    relative: undefined,
    metrics: [
      { value: "$100K-$500K", label: "Check Size" },
      { value: "Seed", label: "Stage" },
      { value: "SaaS", label: "Focus" },
      { value: "8", label: "Portfolio Cos" },
    ],
  },
];
...
const completedMatches = [
  {
    ...
    desc: "Initial chemistry call",
    completedDate: "Mar 5",
    yourRating: 4,
    theirRating: 4 as number | null,
    mutual: true,
    contactEmail: "elena@precursor.vc" as string | undefined,
  },
  {
    id: 5,
    initials: "JP",
    ...
    name: "James Park",
    firm: "Lux Capital",
    desc: "Exploratory conversation",
    completedDate: "Mar 1",
    yourRating: 3,
    theirRating: null as number | null,
    mutual: false,
