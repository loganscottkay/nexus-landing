...
export default function Home() {
  ...
  return (
    <main className="relative min-h-screen bg-base text-text-primary overflow-x-clip">
      ...
      {/* ============ THREE PILLARS ============ */}
      <div className="scroll-stack-section w-full" style={{ position: 'relative', zIndex: 4, backgroundColor: '#FAF9F7' }}>
        <Section className="relative z-10 px-6 py-20 lg:py-24 w-full" style={{}}>
          <div className="max-w-5xl mx-auto">
            ...
            >
              ...
              <motion.h2
                variants={tierTitle}
                transition={{ duration: 0.8, delay: 0.2, ease: smoothDecel }}
                className="text-[36px] md:text-[44px] font-normal text-center mb-14"
                style={{ fontFamily: "'Instrument Serif', serif" }}
              >
                Built Different.
              </motion.h2>
              ...
              >
                {[
                  {
                    title: "Exclusivity",
                    desc: "Curated founders. Serious investors. No noise.",
                    icon: (
                  ...
                  },
                  {
                    ...
                    desc: "Earn visibility through traction\u2014if you don\u2019t show it, you\u2019re off.",
                    icon: (
                  ...
                  },
                  {
                    ...
                    desc: "Match \u2192 meet. No shows don\u2019t stay.",
                    icon: (
                  ...
                  >
                    ...
                    <h3
                      className="text-[18px] font-semibold mb-2 text-text-primary"
                      style={{ fontFamily: "var(--font-dm-sans), sans-serif" }}
                    >
                      {pillar.title}
                    </h3>
                    <p
                      className="text-[14px] leading-[1.7] text-text-muted"
                      style={{ fontFamily: "var(--font-dm-sans), sans-serif" }}
                    >
                      {pillar.desc}
                    </p>
