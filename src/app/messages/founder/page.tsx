    ...
    messages: [
      {
        id: 1,
        sender: "them",
        text: "Hi Alex! I came across Luminary AI on Plejj and your contract analysis platform is exactly what we have been looking for in our portfolio. Would love to learn more.",
        time: "Mon 10:30 AM",
      },
      {
        id: 2,
    ...
    messages: [
      {
        id: 1,
        sender: "them",
        text: "Hey Alex, saw your profile on Plejj. The contract analysis space is interesting. What makes Luminary different from DocuSign's AI features?",
        time: "Mar 3",
      },
      {
        id: 2,
